declare module goog.testing.fs {
     ...
     */
    export function createObjectUrl(blob: goog.testing.fs.Blob): string;
     ...
     */
    export function isObjectUrlGranted(blob: goog.testing.fs.Blob): boolean;
     ...
     */
    export function getBlob(...var_args: string[]): goog.testing.fs.Blob;
     ...
     */
    export function install(stubs: goog.testing.PropertyReplacer): void;
}
