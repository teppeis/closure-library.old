declare module goog.testing.net {
    ...
    export class XhrIo extends goog.events.EventTarget {
         ...
         */
        static getSendInstances(): Array<any>;
         ...
         */
        static send(url: string, opt_callback?: Function, opt_method?: string, opt_content?: string, opt_headers?: Object, opt_timeoutInterval?: number): void;
