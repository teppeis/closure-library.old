declare module goog.testing.ui.style {
     ...
     */
    export function writeReferenceFrame(referencePath: string): void;
     ...
     */
    export function getReferenceNode(referenceId: string): Node;
     ...
     */
    export function getElementChildren(element: Node): Array<Node>;
     ...
     */
    export function isContentNode(element: Node): boolean;
     ...
     */
    export function assertStructureMatchesReference(element: Node, referenceId: string): void;
}
