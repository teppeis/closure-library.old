declare module goog.testing.editor.dom {
     ...
     */
    export function getPreviousNonEmptyTextNode(node: Node, opt_stopAt?: Node, opt_skipDescendants?: boolean): Text;
     ...
     *     an ancestor of node.
     */
    export function getNextNonEmptyTextNode(node: Node, opt_stopAt?: Node, opt_skipDescendants?: boolean): Text;
     ...
     */
    export function assertRangeBetweenText(before: string, after: string, range: goog.dom.AbstractRange, opt_stopAt?: Node): void;
}
