declare module goog.testing.dom {
     ...
     */
    export function exposeNode(node: Node): string;
     ...
     */
    export function exposeRange(range: goog.dom.AbstractRange): string;
     ...
     */
    export function assertHtmlContentsMatch(htmlPattern: string, actual: Node, opt_strictAttributes?: boolean): void;
     ...
     */
    export function assertHtmlMatches(htmlPattern: string, actual: string): void;
     ...
     */
    export function findTextNode(textOrRegexp: string, root: Element): Node;
     ...
     */
    export function assertRangeEquals(start: Node, startOffset: number, end: Node, endOffset: number, range: goog.dom.AbstractRange): void;
}
