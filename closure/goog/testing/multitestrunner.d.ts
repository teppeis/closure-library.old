declare module goog.testing {
     ...
     * @final
     */
    export class MultiTestRunner extends goog.ui.Component {
         ...
         * @return {!goog.testing.MultiTestRunner} Instance for chaining.
         */
        setFilterFunction(filterFn: (arg0: string) => boolean): goog.testing.MultiTestRunner;
         ...
         */
        getFilterFunction(): (arg0: string) => boolean;
