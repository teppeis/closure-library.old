declare module goog.testing {
     ...
     */
    export function FunctionMock(opt_functionName?: string, opt_strictness?: number): goog.testing.MockInterface;
     ...
     */
    export function MethodMock(scope: Object, functionName: string, opt_strictness?: number): goog.testing.MockInterface;
     ...
     */
    export function GlobalFunctionMock(functionName: string, opt_strictness?: number): goog.testing.MockInterface;
     ...
     * @return {goog.testing.MockInterface} The mocked function.
     */
    export function createFunctionMock(opt_functionName?: string, opt_strictness?: number): goog.testing.MockInterface;
     ...
     * @return {goog.testing.MockInterface} The mocked global function.
     */
    export function createMethodMock(scope: Object, functionName: string, opt_strictness?: number): goog.testing.MockInterface;
     ...
     */
    export function createConstructorMock(scope: Object, constructorName: string, opt_strictness?: number): goog.testing.MockInterface;
     ...
     * @return {goog.testing.MockInterface} The mocked global function.
     */
    export function createGlobalFunctionMock(functionName: string, opt_strictness?: number): goog.testing.MockInterface;
}
