declare module goog.soy {
    ...
    export class Renderer {
         ...
         * @template ARG_TYPES
         */
        renderAsFragment<ARG_TYPES>(template: void, opt_templateData?: ARG_TYPES): Node;
         ...
         * @template ARG_TYPES
         */
        renderAsElement<ARG_TYPES>(template: void, opt_templateData?: ARG_TYPES): Element;
         ...
         * @template ARG_TYPES
         */
        renderElement<ARG_TYPES>(element: Element, template: void, opt_templateData?: ARG_TYPES): void;
         ...
         * @template ARG_TYPES
         */
        render<ARG_TYPES>(template: void, opt_templateData?: ARG_TYPES): string;
         ...
         * @template ARG_TYPES
         */
        renderText<ARG_TYPES>(template: void, opt_templateData?: ARG_TYPES): string;
         ...
         */
        renderStrict<ARG_TYPES, RETURN_TYPE>(template: void, opt_templateData?: ARG_TYPES, opt_kind?: goog.soy.data.SanitizedContentKind): RETURN_TYPE;
         ...
         * @template ARG_TYPES
         */
        renderSafeHtml<ARG_TYPES>(template: void, opt_templateData?: ARG_TYPES): goog.html.SafeHtml;
